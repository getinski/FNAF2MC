# armor stand
data modify entity @e[type=armor_stand,sort=nearest,limit=1] Pos set value [21.5d, 1.2d, -18d]
data modify entity @e[type=armor_stand,sort=nearest,limit=1] Rotation set value [0.0f, 0.0f]
data modify entity @e[type=armor_stand,sort=nearest,limit=1] Pose set value {Body:[255f,93f,0f],Head:[0f,0f,60f],LeftLeg:[235f,93f,6f],RightLeg:[166f,134f,326f],LeftArm:[119f,311f,0f],RightArm:[119f,0f,0f]}
